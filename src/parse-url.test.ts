...
describe('parseUrl', () => {
  describe('YouTube', () => {
    ...
    it('parses watch URLs with extra params', () => {
      expect(parseUrl('https://youtube.com/watch?v=abc123&t=42s&list=PL1234')).toEqual({
        provider: 'youtube',
        id: 'abc123',
      })
    })
  ...
  describe('Spotify', () => {
    it('parses track URLs', () => {
      expect(parseUrl('https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT')).toEqual({
        provider: 'spotify',
  ...
  describe('Discogs', () => {
    ...
    it('parses release URLs with slug', () => {
      expect(parseUrl('https://discogs.com/release/12345-Artist-Album-Name')).toEqual({
        provider: 'discogs',
        id: '12345',
      })
    })
    ...
    it('parses URLs with locale prefix', () => {
      expect(parseUrl('https://www.discogs.com/de/release/12345-Artist-Album')).toEqual({
        provider: 'discogs',
        id: '12345',
      })
    })
    ...
    it('parses master URLs with locale', () => {
      expect(parseUrl('https://discogs.com/fr/master/67890-Artist-Album')).toEqual({
        provider: 'discogs',
        id: '67890',
      })
    })
